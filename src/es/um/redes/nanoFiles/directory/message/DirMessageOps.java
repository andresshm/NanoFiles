...
public class DirMessageOps {
	...
	// Los Opcode de todos los mensajes que utilizamos.
	...
	//public static final byte OPCODE_USERLISTFAIL = 16;
	public static final byte OPCODE_GETFILES = 14;
	public static final byte OPCODE_FILELIST = 15;
	public static final byte OPCODE_SERVE_STOP = 16;
	public static final byte OPCODE_SERVE_STOP_OK = 17;
	public static final byte OPCODE_SERVE_STOP_FAIL = 18;
	public static final byte OPCODE_QUIT = 19;
	public static final byte OPCODE_QUIT_OK = 20;
	public static final byte OPCODE_QUIT_FAIL = 21;
	...
	private static final Byte[] _valid_opcodes = { 
			...
			OPCODE_FILELIST,
			OPCODE_SERVE_STOP,
			OPCODE_SERVE_STOP_OK,
			OPCODE_SERVE_STOP_FAIL,
			OPCODE_QUIT,
			OPCODE_QUIT_OK,
			OPCODE_QUIT_FAIL};
