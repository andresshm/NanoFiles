...
public class NFCommands {
	...
	public static final byte COM_BGSTOP = 12;
	public static final byte COM_FGSTOP = 13;
	...
	private static final String[] _valid_user_commands_help = {
			...
			"to finish serving shared files on <port> in backgroundd",
			"to finish serving shared files on <port> in foreground",
